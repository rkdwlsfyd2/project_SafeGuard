...
class UnifiedComplaintManager:
    ...
    def __init__(self):
        ...
        # 18~38번까지의 대한민국 주요 기관 매핑
        self.AGENCIES = {
            18: "경찰청", 19: "국토교통부", 20: "고용노동부", 21: "국방부",
            22: "국민권익위원회", 23: "식품의약품안전처", 24: "대검찰청", 25: "기획재정부",
            26: "행정안전부", 27: "보건복지부", 28: "과학기술정보통신부", 29: "국세청",
            30: "기후에너지환경부", 31: "법무부", 32: "공정거래위원회", 33: "교육부",
            34: "해양수산부", 35: "농림축산식품부", 36: "소방청", 37: "인사혁신처",
            38: "기타"
        }

        # 분류 정확도를 높이기 위한 기관별 핵심 키워드 정의
        self.AGENCY_KEYWORDS = {
            18: ["경찰", "범죄", "도둑", "사기", "교통사고", "불법", "수사", "신고"],
            19: ["도로", "교통", "주택", "건설", "아파트", "철도", "고속도로", "운전면허"],
            20: ["노동", "임금", "체불", "근로", "직장", "해고", "고용"],
            21: ["군대", "국방", "군인", "병무", "예비군"],
            22: ["비리", "부패", "권익", "고충", "청렴"],
            23: ["음식", "식당", "약품", "위생", "식약처", "유통기한"],
            24: ["검찰", "기소", "검사"],
            25: ["예산", "경제", "재정"],
            26: ["행정", "안전", "정부", "민방위", "재난"],
            27: ["복지", "연금", "기초생활", "보건", "병원", "의료"],
            28: ["통신", "인터넷", "과학", "IT", "기술", "방송"],
            29: ["세금", "국세", "연말정산", "탈세"],
            30: ["환경", "쓰레기", "오염", "미세먼지", "기후", "에너지"],
            31: ["법무", "교도소", "출입국", "비자"],
            32: ["거래", "공정", "독과점", "담합"],
            33: ["학교", "교육", "선생님", "대학", "수업"],
            34: ["바다", "해양", "수산", "어선", "항구"],
            35: ["농사", "농림", "축산", "식품", "축사"],
            36: ["불", "화재", "구조", "구급", "119", "소방"],
            37: ["공무원", "인사", "채용", "공직"],
        }
        
        # 사용자에게 보여줄 카테고리명
        self.AGENCY_CATEGORIES = {
            18: "경찰/수사", 19: "교통/건설", 20: "고용/노동", 21: "국방/보훈",
            22: "행정/권익", 23: "보건/위생", 24: "검찰/법무", 25: "재정/경제",
            26: "행정/안전", 27: "보건/복지", 28: "과학/방송", 29: "세무/금융",
            30: "환경/기상", 31: "법무/이민", 32: "산업/통상", 33: "교육/학술",
            34: "해양/수산", 35: "농축/식품", 36: "소방/안전", 37: "행정/인사",
            38: "기타"
        }
